...
def generate_business_plan(client, business_info):
    prompt = f"""
    Dựa vào thông tin:
...
def save_business_plan(content, output_path="1_xac_dinh_y_tuong.txt"):
    try:
...
def main():
    ...
    if business_info:
        business_plan = generate_business_plan(client, business_info)
